...
adminSource = adminSource.replaceAll("/api/send-manual-booking-emails", "/api/send-confirmation-email");
...
console.log("Email prenotazioni uniformate senza aggiungere nuove funzioni Vercel.");
